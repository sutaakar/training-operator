...
class IoK8sApiSchedulingV1alpha3PodGroup(BaseModel):
    """
    ...
    spec: IoK8sApiSchedulingV1alpha3PodGroupSpec = Field(description="spec defines the desired state of the PodGroup.")
    status: Optional[IoK8sApiSchedulingV1alpha3PodGroupStatus] = Field(default=None, description="status represents the current observed state of the PodGroup.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3PodGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3PodGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoK8sApiSchedulingV1alpha3PodGroupSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": IoK8sApiSchedulingV1alpha3PodGroupStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
