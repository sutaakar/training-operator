...
class IoK8sApiCoreV1NodeSystemInfo(BaseModel):
    ...
    running_in_user_namespace: Optional[StrictBool] = Field(default=None, description="Whether the node is running in a user namespace.", alias="runningInUserNamespace")
