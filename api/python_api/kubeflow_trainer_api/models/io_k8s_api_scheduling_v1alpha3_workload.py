...
class IoK8sApiSchedulingV1alpha3Workload(BaseModel):
    """
    ...
    spec: IoK8sApiSchedulingV1alpha3WorkloadSpec = Field(description="spec defines the desired behavior of a Workload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3Workload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3Workload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoK8sApiSchedulingV1alpha3WorkloadSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
