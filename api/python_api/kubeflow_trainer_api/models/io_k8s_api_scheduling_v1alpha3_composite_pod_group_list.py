...
class IoK8sApiSchedulingV1alpha3CompositePodGroupList(BaseModel):
    """
    ...
    items: List[IoK8sApiSchedulingV1alpha3CompositePodGroup] = Field(description="Items is the list of CompositePodGroups.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3CompositePodGroupList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sApiSchedulingV1alpha3CompositePodGroupList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [IoK8sApiSchedulingV1alpha3CompositePodGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
